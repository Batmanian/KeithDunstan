...
| 11 | Columns on the Mysteries of Survival | 📝 in progress, confirmed 11 Aug 2026 | Real heading confirmed by scan (not 'Problems of Survival' as guessed). 6 of ~10 columns transcribed: `56-when-im-sixty-four.md`, `57-when-im-sixty-five.md`, `58-rally-please-to-the-society-against-progress.md`, `59-mr-suzuki-im-trying-honestly.md`, `60-the-comforts-of-being-locked-up.md`, `61-hail-to-the-umbrageous-coast.md`. Remaining titles as previously guessed for the old mislabeled "Chapter 12" (In Bad Times You Cover Up; Never Trust a Banker With a Christian Name; Can We Have a Dinkum Aussie Theme Park; Printophobia - There's No Known Cure) — not yet transcribed; next heading not yet confirmed on scan |
| 12 | Unknown | ⬜ | The previously-guessed 'Columns of Immense Social Importance' list turned out to be Chapter 11's real content (see above), so Chapter 12's real heading and columns are completely unknown pending a scan |
